...
public class PlaceholderAPISupport extends PlaceholderExpansion {
    ...
    @Override public String getVersion()    { return NotKillRank.getInstance().getDescription().getVersion(); }
    @Override public boolean persist()      { return true; }

    @Override
    public boolean canRegister() {
        return ModuleManager.getInstance().isEnabled(ModuleManager.Module.PLACEHOLDERAPI)
                && NotKillRank.getInstance() != null
                && NotKillRank.getInstance().isEnabled();
    }
